...
public class TransferService {
    ...
    public Transfer transfer(NewTransfer trReq) {
        return db.context().transactionResult(configuration -> {
            DSL.using(configuration)
                    ...
                    .forUpdate().fetchInto(com.revolut.money.transfer.model.Account.class);
    ...
    private class TransferRecordMapper implements RecordMapper<Record, Transfer> {
        ...
        public Transfer map(Record record) {
            com.revolut.money.transfer.model.Account fromAcc =
                    new com.revolut.money.transfer.model.Account(record.get(fromAccount.ID), record.get(fromAccount.NUMBER));
            com.revolut.money.transfer.model.Account toAcc =
                    new com.revolut.money.transfer.model.Account(record.get(toAccount.ID), record.get(toAccount.NUMBER));
